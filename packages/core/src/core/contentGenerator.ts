...
import { OllamaContentGenerator } from '../ollama/ollamaClient.js';
...
export function createContentGeneratorConfig(
  ...
  if (!effectiveModel) {
    effectiveModel = authType === AuthType.USE_OLLAMA ? DEFAULT_OLLAMA_MODEL : DEFAULT_GEMINI_MODEL;
  }
...
export async function createContentGenerator(
  ...
  if (config.authType === AuthType.USE_OLLAMA) {
    ...
    const ollamaClient = new OllamaContentGenerator(ollamaConfig);
    return new LoggingContentGenerator(ollamaClient, gcConfig);
  }
